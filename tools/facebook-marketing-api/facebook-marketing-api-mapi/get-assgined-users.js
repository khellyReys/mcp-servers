 ...
 * @param {string} [args.fields='id,tasks,user_type,permitted_tasks'] - The fields to return in the response.
 * @returns {Promise<Object>} - The response containing assigned users.
 */
const executeFunction = async ({ account_id, business_id, fields = 'id,tasks,user_type,permitted_tasks' }) => {
  ...
  try {
    ...
    const url = new URL(`${baseUrl}/act_${account_id}/assigned_users`);
