 ...
 *
 * @param {Object} args - Arguments for the creative details request.
...
const executeFunction = async ({ adCreativeId }) => {
  ...
  try {
    ...
    return { error: 'An error occurred while getting creative details.' };
  }
};
...
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'Get details of a specific ad creative from Facebook Marketing API.',
      parameters: {
        type: 'object',
        properties: {
          adCreativeId: {
