 ...
 * @param {string} args.report_id_breakdowns - The report ID for which insights are to be fetched.
      ...
      parameters: {
        ...
        properties: {
          ...
          report_id_breakdowns: {
            type: 'string',
            description: 'The report ID for which insights are to be fetched.'
          }
        },
