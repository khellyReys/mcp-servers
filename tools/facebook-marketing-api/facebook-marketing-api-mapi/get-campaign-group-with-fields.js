 ...
 *
 * @param {Object} args - Arguments for the campaign group request.
 * @param {string} args.campaign_id_traffic - The ID for the traffic campaign.
 * @param {string} args.campaign_id_awareness - The ID for the awareness campaign.
 * @param {string} args.campaign_id_sales - The ID for the sales campaign.
 * @returns {Promise<Object>} - The result of the campaign group request.
 */
const executeFunction = async ({ campaign_id_traffic, campaign_id_awareness, campaign_id_sales }) => {
  ...
  try {
    ...
    console.error('Error getting campaign groups:', error);
    return { error: 'An error occurred while getting campaign groups.' };
  }
};

/**
 * Tool configuration for getting campaign groups from the Facebook Marketing API.
 * @type {Object}
 */
const apiTool = {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          campaign_id_traffic: {
            type: 'string',
            description: 'The ID for the traffic campaign.'
          },
          campaign_id_awareness: {
            type: 'string',
            description: 'The ID for the awareness campaign.'
          },
          campaign_id_sales: {
            type: 'string',
            description: 'The ID for the sales campaign.'
          }
        },
