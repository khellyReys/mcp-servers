...
const executeFunction = async ({ account_id, base_url }) => {
  ...
  try {
    ...
    console.error('Error getting ad sets list:', error);
    return { error: 'An error occurred while getting the ad sets list.' };
  }
};

/**
 * Tool configuration for getting the list of ad sets from the Facebook Marketing API.
 * @type {Object}
 */
const apiTool = {
