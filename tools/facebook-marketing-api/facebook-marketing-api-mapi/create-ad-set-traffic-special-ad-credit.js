 ...
 */
const executeFunction = async ({ account_id, campaign_id, name = "PostMancAdsetTrafficCampaign", billing_event = "LINK_CLICKS", targeting, start_time = "2024-06-16T04:45:17+0000", status = "PAUSED" }) => {
