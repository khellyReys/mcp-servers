/**
 * Function to get ad set details for a specific ad account from the Facebook Marketing API.
 *
 ...
 * @returns {Promise<Object>} - The details of the ad sets for the specified account.
 */
...
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'Get ad set details for a specific ad account.',
      parameters: {
        type: 'object',
        properties: {
          account_id: {
